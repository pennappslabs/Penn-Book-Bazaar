...
elseif (cG("action")=="senddeactivate") {
  ...
  while ($row = mysql_fetch_array($result))
  {
    ...
    $message = "<html>
      ...
      <font size=4>You posted \"$title\" more than a month ago on Penn Book Bazaar. If you have sold this textbook or if it is no longer available please <a href='http://pennbookbazaar.com/manage/?post=$id&pwid=$pwid&action=deactivate'>deactivate</a> your listing from our directory.</font><br /><br />
