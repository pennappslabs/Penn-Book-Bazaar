...
require_once('header.php');
  ...
  while ($row = mysql_fetch_array($result)) 
  {
    ...
    $message = "<html>
      ...
      <font size=4>You have been contacted about \"$title\" more than three times through Penn Book Bazaar. If you have sold this textbook or if it is no longer available please <a href='http://pennua.org/textbook/manage/?post=$id&pwid=$pwid&action=deactivate'>deactivate</a> your listing from our directory.</font><br /><br />
