...
// no theme found so we are gonna create an entirely new index page from scratch
// this code will most likely never run because
// we DO have a theme at /themes/wpClassified
// so the themes/wpClassified index page will be shown
else {
